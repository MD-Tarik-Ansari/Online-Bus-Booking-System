...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top mask-custom shadow-0">
    <div class="container">
      <a class="navbar-brand" href="#!"><span style="color: #627996;">AdminProfile</span></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="addBus.jsp">AddBus</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="display.jsp">DisplayBus</a>
          </li>
          <li class="nav-item">
