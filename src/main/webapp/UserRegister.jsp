          ...
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="userRegister" method="post">
                ...
                <div class="form-outline mb-3 d-flex justify-content-center">
                  <input type="email" id="form3Example3cg" class="form-control-lg vw-100"  placeholder="Enter Your Email" name="email"/>
                ...
                <div class="form-outline mb-3 d-flex justify-content-center">
                  <input type="tel" id="form3Example4cdg" class="form-control-lg vw-100"  placeholder="Enter Your Mobile No." name="phone"/>
