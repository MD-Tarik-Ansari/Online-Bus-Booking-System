...
<body>
    ...
    <div class="container">
     ...
     <section class="vh-100 .bg-info.bg-gradient">
            ...
            <div class="card-body p-5">
              ...
              <form action="userLogin" method="post">
                ...
                <div class="form-outline mb-3 d-flex justify-content-center">
                  <input type="email" id="form3Example3cg" class="form-control-lg vw-100" placeholder="Enter Your Email" name="username"/>
                </div>

                <div class="form-outline mb-3 d-flex justify-content-center">
                  <input type="password" id="form3Example4cg" class=" form-control-lg vw-100" placeholder="Enter Your Password" name="password"/>
                </div>
  ...
  <div class="text-center">
    <p>If Not Registered ? <a href="UserRegister.jsp"><u>New Registration</u></a></p>
